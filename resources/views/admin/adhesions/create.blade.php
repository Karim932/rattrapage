...
<div id="main-content" class="flex-1 ml-64 p-10 transition-all">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('adhesion.store') }}"class="bg-white p-8 shadow-lg rounded-lg space-y-6">
            ...
            <!-- Choix entre Bénévole et Commerçant -->
            <div class="mb-6">
                <label class="form-label block text-gray-700 text-sm font-bold mb-2">Type d'Adhésion :</label>
                <select name="type-user" id="type-user" class="form-select mt-1 block w-full">
                    <option value="benevole">Bénévole</option>
                    <option value="commercant">Commerçant</option>
                </select>
            </div>

            <!-- Menu déroulant des utilisateurs sans candidature -->
            <div class="mb-6">
...
<script>
        ...
        // Gestion des attributs 'required' pour la section Commerçant
