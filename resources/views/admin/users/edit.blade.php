...
@section('title', 'Modifier l\'Utilisateur | NoMoreWaste')

@section('content')
<div id="main-content" class="flex-1 ml-64 p-10 transition-all">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Modifier l'Utilisateur</h1>
    ...
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-6">
        <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="lastname" id="lastname" value="{{ old('lastname', $user->lastname) }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('lastname')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $user->date_of_birth) }}" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('date_of_birth')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="address" id="address" value="{{ old('address', $user->address) }}" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('address')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="city" id="city" value="{{ old('city', $user->city) }}" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('city')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="country" id="country" value="{{ old('country', $user->country) }}" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('country')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $user->phone_number) }}" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('phone_number')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="role" id="role" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    ...
                    <option value="benevole" {{ old('role', $user->role) === 'benevole' ? 'selected' : '' }}>Bénévole</option>
                    <option value="commercant" {{ old('role', $user->role) === 'commercant' ? 'selected' : '' }}>Commerçant</option>
                    <option value="banned" {{ old('role', $user->role) === 'banned' ? 'selected' : '' }}>Banni</option>
                </select>
                @error('role')
                    <p class="text-red-600 text-sm">{{ $message }}</p>
                @enderror
